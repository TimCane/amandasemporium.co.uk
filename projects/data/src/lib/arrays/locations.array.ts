...
export const locations: ILocation[] = [addlestone, aldershot, alton, andover, appledram, ardingly, ashford, ashGreen, ashVale, bansted, barkham, basingstoke, bealePark, berrylands, bexhillOnSea, billingshurst, binfield, birdham, blackwater, bognor, bordon, bosham, bourneEnd, bracknell, bridgemary, bridgewater, broadbridgeHeath, burghfield, burnham, byfleet, camberley, caterham, chertsey, chertseySouth, chessington, chicester, chichester, chippenham, churchCrookham, clapham, cobham, cove, cranleigh, crawley, crowborough, croydon, dorchester, durham, eastGrinstead, effingham, egham, ely, emsworth, englefieldGreen, epsom, etonWick, ewell, farlington, farnborough, farnham, fetcham, fleet, folkstone, godalming, greenwich, guildford, hailsham, hammersmith, hartleyWintney, haylingIsland, hongKong, hook, horley, horsell, horsham, horsley, hunston, hurley, kingsbridge, kingston, knaphill, leatherhead, leeds, leicester, london, longDitton, maidenhead, middleton, miltonKeynes, minsterLovell, morden, newbury, normandy, nottingham, odiham, oswestry, ottershaw, pagham, philadelphiaUSA, portsmouth, reading, richmond, ripley, romsey, rowtown, royalTunbridgeWells, ruislip, seaford, selsey, send, shepperton, shrewsbury, sidlesham, smallfield, southampton, southsea, southShields, staines, steventon, stilton, stokedAbernon, sunbury, surbiton, surbitonNurseySchool, sutton, tadley, taplow, thatcham, theale, tidworth, tilford, titchfield, tonbridge, upton, wallingford, waltonOnThames, waltonUponThames, wandsworth, westMolesey, westWittering, weybridge, whitchurchHill, windsor, winnersh, wisley, woking, wokingham, yateley];