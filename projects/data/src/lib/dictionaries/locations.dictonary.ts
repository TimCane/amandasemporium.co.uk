...
export const locations: { [name: string]: ILocation } = {addlestone, aldershot, andover, appledram, ashford, ashGreen, bansted, barkham, basingstoke, berrylands, bexhillOnSea, billingshurst, binfield, birdham, blackwater, bognor, bordon, bosham, bourneEnd, bracknell, bridgemary, bridgewater, broadbridgeHeath, burnham, byfleet, camberley, caterham, chertsey, chertseySouth, chessington, chicester, chichester, chippenham, churchCrookham, clapham, cobham, cove, crawley, crowborough, dorchester, durham, eastGrinstead, effingham, egham, ely, emsworth, emworth, epsom, etonWick, ewell, farlington, farnborough, farnham, fleet, folkstone, godalming, greenwich, guildford, hailsham, hammersmith, haylingIsland, hongKong, hook, horley, horsell, horsham, horsley, hunston, hurley, kingsbridge, kingston, leatherhead, leeds, leicester, longDitton, maidenhead, middleton, miltonKeynes, minsterLovell, newbury, normandy, odiham, oswestry, ottershaw, pagham, philadelphiaUSA, portsmouth, reading, richmond, ripley, romsey, rowtown, royalTunbridgeWells, ruislip, selsey, send, shepperton, shrewsbury, sidlesham, smallfield, southampton, southsea, southShields, staines, steventon, stilton, stokedAbernon, sunbury, surbiton, surbitonNurseySchool, sutton, tadley, taplow, theale, tidworth, titchfield, tonbridge, wallingford, waltonOnThames, waltonUponThames, wandsworth, westMolesey, westWittering, weybridge, windsor, winnersh, wisley, woking, wokingham, yateley};